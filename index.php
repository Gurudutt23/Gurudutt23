      ...
      <nav id="nav-wrap">
        ...
        <a class="mobile-btn" href="#" title="Hide navigation">Hide navigation</a>
         ...
         <ul id="nav" class="nav">
           ...
           <li><a class="smoothscroll" href="#resume">Employee</a></li>
...
?>
   ...
   <section id="about">
      ...
      <div class="row">
         ...
         <img class="profile-pic" src="profile_asset/images/GDS STUDIOS.png" alt="" />
            ...
            <div class="row item">
               ...
               <div class="twelve columns">
                  <div class="three columns">
                     ...
                     <img class="profile-pic" src="profile_asset/images/profilepic.jpg" alt="" />
